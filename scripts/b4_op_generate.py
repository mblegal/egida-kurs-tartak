...
TYPE_CONFIGS: dict[str, TypeConfig] = {
    ...
    "zestawienie-zbiorcze-ocen": TypeConfig(
        slug="zestawienie-zbiorcze-ocen",
        typ_path="O3-ocena/19-zestawienie-zbiorcze-ocen",
        languages=("pl",),
        row_id_field="NR_ZESTAWIENIA",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_GENERACJI", "LICZBA_KURSANTOW",
            "LICZBA_ZALICZONYCH", "LICZBA_NIEZALICZONYCH", "LICZBA_PRZERWANYCH",
            "SREDNI_WYNIK_TEST_M1", "SREDNI_WYNIK_TEST_M2", "SREDNI_WYNIK_TEST_M3",
            "SREDNI_WYNIK_TKK", "PROCENT_ZDAWALNOSCI",
            "KOORDYNATOR_KURSU", "INSTRUKTOR_GLOWNY", "NR_ZESTAWIENIA",
        ),
    ),
    "protokol-zakonczenia-kursu": TypeConfig(
        slug="protokol-zakonczenia-kursu",
        typ_path="O4-zamkniecie/01-protokol-zakonczenia-kursu",
        languages=("pl",),
        row_id_field="NR_PROTOKOLU",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_ROZPOCZECIA", "DATA_ZAKONCZENIA",
            "LICZBA_KURSANTOW", "LICZBA_ZALICZONYCH",
            "MIEJSCE_ZAJEC", "KOORDYNATOR_KURSU", "INSTRUKTOR_GLOWNY",
            "INSTRUKTORZY_LISTA", "LICZNA_GODZIN", "UWAGI_KOORDYNATORA",
            "NR_PROTOKOLU", "DATA_PROTOKOLU",
        ),
    ),
    "lista-absolwentow": TypeConfig(
        slug="lista-absolwentow",
        typ_path="O4-zamkniecie/02-lista-absolwentow",
        languages=("pl",),
        row_id_field="NR_LISTY_ABSOLWENTOW",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_GENERACJI", "LICZBA_ABSOLWENTOW",
            "KOORDYNATOR_KURSU", "DATA_PROTOKOLU_ZAKONCZENIA",
            "NR_PROTOKOLU_ZAKONCZENIA", "NR_LISTY_ABSOLWENTOW",
        ),
    ),
    "rejestr-wydanych-zaswiadczen": TypeConfig(
        slug="rejestr-wydanych-zaswiadczen",
        typ_path="O4-zamkniecie/03-rejestr-wydanych-zaswiadczen",
        languages=("pl",),
        row_id_field="NR_REJESTRU",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_OTWARCIA_REJESTRU", "DATA_ZAMKNIECIA_REJESTRU",
            "LICZBA_ZASWIADCZEN_KURSU", "LICZBA_ZASWIADCZEN_MODULOWYCH",
            "KOORDYNATOR_KURSU", "NR_REJESTRU",
        ),
    ),
    "raport-koncowy-edycji": TypeConfig(
        slug="raport-koncowy-edycji",
        typ_path="O4-zamkniecie/04-raport-koncowy-edycji",
        languages=("pl",),
        row_id_field="NR_RAPORTU",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_RAPORTU", "LICZBA_KURSANTOW",
            "LICZBA_ABSOLWENTOW", "PROCENT_ZDAWALNOSCI", "SREDNI_WYNIK_TKK",
            "LICZBA_INCYDENTOW", "GLOWNE_OSIAGNIECIA", "GLOWNE_PROBLEMY",
            "REKOMENDACJE_KOLEJNE_CYKLE", "KOORDYNATOR_KURSU",
            "INSTRUKTOR_GLOWNY", "NR_RAPORTU",
        ),
    ),
    "karta-edycji-kursu": TypeConfig(
        slug="karta-edycji-kursu",
        typ_path="O4-zamkniecie/05-karta-edycji-kursu",
        languages=("pl",),
        row_id_field="NR_KARTY_EDYCJI",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_OTWARCIA_KARTY", "DATA_ZAMKNIECIA_KARTY",
            "DATA_ROZPOCZECIA_CYKLU", "DATA_ZAKONCZENIA_CYKLU",
            "MIEJSCE_GLOWNE", "MIEJSCE_PRAKTYK",
            "LICZBA_KURSANTOW_REKRUTOWANYCH", "LICZBA_KURSANTOW_KONCZACYCH",
            "LICZBA_ABSOLWENTOW", "LICZNA_GODZIN",
            "KOORDYNATOR_KURSU", "INSTRUKTOR_GLOWNY", "INSTRUKTORZY_LISTA",
            "NR_KARTY_EDYCJI",
        ),
    ),
    "spis-dokumentacji-edycji": TypeConfig(
        slug="spis-dokumentacji-edycji",
        typ_path="O4-zamkniecie/06-spis-dokumentacji-edycji",
        languages=("pl",),
        row_id_field="NR_SPISU",
        expected_placeholders=(
            "CYKL_KURSU", "DATA_SPORZADZENIA", "LICZBA_DOKUMENTOW",
            "MIEJSCE_PRZECHOWYWANIA", "KOORDYNATOR_KURSU", "NR_SPISU",
        ),
    ),
    "skreslenie-z-listy": TypeConfig(
        slug="skreslenie-z-listy",
        typ_path="O5-incydenty/03-skreslenie-z-listy",
        languages=("pl",),
        row_id_field="NR_SKRESLENIA",
        expected_placeholders=(
            "IMIE_KURSANTA", "NAZWISKO_KURSANTA", "NR_KARTY_UCZESTNIKA",
            "CYKL_KURSU", "DATA_SKRESLENIA", "PRZYCZYNA_SKRESLENIA",
            "INICJATOR_SKRESLENIA", "PROCENT_UKONCZENIA",
            "WYDANE_ZASWIADCZENIA", "KOORDYNATOR_KURSU", "NR_SKRESLENIA",
        ),
    ),
    "protokol-wypadku": TypeConfig(
        slug="protokol-wypadku",
        typ_path="O5-incydenty/04-protokol-wypadku",
        languages=("pl",),
        row_id_field="NR_PROTOKOLU",
        expected_placeholders=(
            "IMIE_POSZKODOWANEGO", "NAZWISKO_POSZKODOWANEGO", "ROLA_POSZKODOWANEGO",
            "DATA_WYPADKU", "GODZINA_WYPADKU", "MIEJSCE_WYPADKU",
            "OPIS_ZDARZENIA", "RODZAJ_OBRAZEN", "PIERWSZA_POMOC",
            "WEZWANE_SLUZBY", "SWIADKOWIE_LISTA",
            "INSTRUKTOR_PIERWSZEJ_LINII", "KOORDYNATOR_KURSU",
            "DATA_PROTOKOLU", "NR_PROTOKOLU",
        ),
    ),
}
