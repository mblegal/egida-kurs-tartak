...
En la l1 cruzaste el umbral del M3: «informe después del hecho, no antes de la operación». Hoy te vamos a mostrar **la otra mitad del mismo turno**. Si el informe es tu voz **después** del turno, la charla de seguridad es tu voz **antes** del turno. Cinco minutos, tres personas, un tema. Ni una consigna, ni una clase académica. Un ritual corto que en el aserradero polaco abre el turno y lo protege durante ocho horas.
...
1. Sabes qué dice el *art. 237³ Kodeksu pracy* (art. 237³ del Código de Trabajo polaco) sobre las charlas del puesto y en qué se diferencia la charla del puesto de la charla general de la empresa.
2. Conoces el formato de cinco minutos (apertura, tema, ejemplo concreto, pregunta, firma) y sabes representarlo por parejas.
3. Reconoces las cinco fuentes del tema de la charla (materia prima nueva, meteorología, avería del turno anterior, persona nueva en el equipo, pedido especial) y eliges un tema que encaje con el día.
4. Sabes apuntar la charla en el *dziennik stanowiskowy* (diario del puesto) en un formato que pasa la inspección de la *PIP*.
5. Reconoces los cinco errores típicos de la primera charla (demasiado larga, sin tema, monólogo, sin firma, parafrasear) y sabes cuál te amenaza más a ti.

## Contenido

### Para qué sirve realmente una charla del puesto

El *Kodeks pracy* (Código de Trabajo polaco) tiene tres capas de formación en SSL: inicial (al contratar), periódica (cada 1 a 3 años según el puesto) y **continua** (a diario, en el puesto de trabajo, antes de iniciar el turno). La tercera capa es justamente la *odprawa stanowiskowa* (charla de seguridad del puesto). Es la más corta, la más frecuente y la más cercana a la realidad del día. La formación inicial dice «la máquina es peligrosa». La charla del puesto dice «**hoy** la máquina es peligrosa por este motivo concreto».

La base legal es el *art. 237³ § 2 Kodeksu pracy* (el empresario facilita al trabajador información continua sobre el riesgo laboral) y el *Rozporządzenie MGiP* (Reglamento del Ministerio de Economía y Trabajo polaco) de 27 de julio de 2004 sobre formación en SSL (§ 4 apdo. 3). En el aserradero se añade el *Rozporządzenie MG* (Reglamento del Ministerio de Economía polaco) de 14 de abril de 2000 sobre SSL en la operación de máquinas para madera (§ 2), que exige un instructivo aparte para cada puesto.

::: info
En la jurisprudencia de los tribunales laborales polacos (línea jurisprudencial del *Sąd Najwyższy* (Tribunal Supremo polaco), entre otras resoluciones de los años 2010 a 2018) la charla del puesto se trata como **prueba de la diligencia debida del empresario**. La falta de apunte en el diario de charlas cuando ocurre un accidente desplaza la carga de la prueba al empresario y suele terminar en un importe más alto de indemnización. Para el operador autónomo esto significa una sola cosa: **una charla sin firma es como si no hubiera existido**. La firma es cinco veces más importante que el contenido.
:::

### Charla general de la empresa y charla del puesto: quién hace qué

La empresa lleva dos capas de charlas. El *mistrz zmiany* (jefe de turno) abre el día con una **charla general de la empresa** (5 a 10 minutos, todo el equipo, temas generales: meteorología, pedidos del día, asuntos de personal). Tú abres tu puesto con una **charla del puesto** (5 minutos, tu equipo en la P3, tema concreto ligado a la máquina y a la materia prima).

Tres diferencias son críticas.

**Tamaño del equipo.** El *mistrz zmiany* habla a unas 20 personas. Tú, a 2 o 3 (ayudante, operador junior y, a veces, el carretillero si vais a trabajar juntos). Equipo más pequeño = puedes hablar por el nombre, no «compañeros».

**Especificidad del tema.** El *mistrz zmiany* dice «hoy cuidado con el agua en el patio, dos grados sobre cero, puede estar resbaladizo». Tú dices «hoy la sierra P3 después del cambio de cinta de ayer, primer turno después del fin de semana, cinta fría, primeros 15 minutos sin prisa, calentamiento completo».

**Formato del apunte.** El *mistrz zmiany* apunta en el *dziennik główny* (diario principal) de la empresa. Tú, en el *dziennik stanowiskowy* (diario del puesto) de la P3 (papel o tableta). Dos documentos distintos, dos archivos distintos, los dos protegidos por la misma firma.

::: warning
La trampa más frecuente de los operadores que entran en el M3: **creer que la charla del *mistrz zmiany* ya basta**. No basta. El *mistrz zmiany* habló a 20 personas sobre la meteorología. Tú tienes la obligación de hablar a 2 personas sobre **tu máquina**. En inspección la *PIP* pregunta por el *dziennik stanowiskowy*, no por el *dziennik główny*. Si falta tu apunte, es tu cabeza, no la del *mistrz*.
:::

### Formato de cinco minutos: cinco bloques de un minuto

La charla tiene que mantener ritmo. Cinco bloques de 60 segundos cada uno. Ni cuatro, ni seis. Cinco. La primera semana lo mides con reloj, después se te mete en la mano.
...
> «Hoy, después del cambio de cinta del sábado, la sierra arranca el primer turno. Cinta fría. Primeros 15 minutos sin prisa, calentamiento completo sin carga.»
...
### Cinco fuentes del tema del día

Sin tema la charla está vacía. Con tema es prueba de que miraste el puesto antes de llamar al equipo. Cinco fuentes de tema, de las que eliges una cada día.

**1. Materia prima nueva.** Ha llegado una partida de roble en vez de pino. Partida fresca en vez de seca. Troncos congelados tras el fin de semana. Cada cambio de materia prima cambia los parámetros de corte, el riesgo de rechazo de la cinta, el ruido. Primer día de materia prima nueva = tema de charla automático.

**2. Meteorología.** Helada por debajo de -5 °C (condensación en el motor). Humedad por encima del 85% (guías resbaladizas). Tormenta durante la noche (cortes eléctricos, reinicio de los controladores). Tres días de calor seguidos (sobrecalentamiento de motores). La meteorología entra en la charla en el momento extremo, no a diario.
...
El formato del apunte es sencillo, pero tiene cinco elementos obligatorios. La ausencia de cualquiera de ellos abre la puerta a una objeción por parte de la *PIP* o del tribunal laboral.
...
El *dziennik stanowiskowy* de la P3 se archiva 3 años (ajuste estándar en los aserraderos certificados *FSC/PEFC*) o 5 años (aserraderos que procesan madera de construcción con documentación de resistencia). Tu apunte de la charla de hoy se puede abrir dentro de 2 años, en un litigio judicial, en una auditoría *FSC* o en una inspección de la *PIP* tras un accidente.

::: warning
Una de las incidencias más frecuentes que la *PIP* anota en las actas de inspección de los aserraderos: **desfase temporal entre la charla y el apunte**. El operador dirige la charla a las 6:55, después arranca a trabajar, y apunta recién a las 11:00 tras la pausa del desayuno. Mientras tanto ha ocurrido un incidente menor (por ejemplo, el ayudante se ha cortado la mano), que podría estar ligado al contenido de la charla. El desfase entre 6:55 y 11:00 implica que el apunte se «añadió» después del hecho. El tribunal laboral lo trata como falsificación de documento, aunque el contenido sea cierto. Regla: **apunte inmediato, antes de arrancar la máquina**. Cinco segundos de escritura = cinco años de protección legal.
:::

### Cinco errores típicos de la primera charla

De la observación de los formadores EGIDA durante los últimos 5 años se destilan cinco errores que comete la mayoría de los operadores en el primer mes de M3. Memorízalos; cada uno le ha costado caro ya a alguien.

1. **Demasiado larga.** El operador habla 12 minutos en vez de 5. Después del octavo minuto el equipo deja de escuchar y empieza a pensar en el desayuno. El contenido deja de llegar. Regla: **si el tema pide 10 minutos, divídelo en dos temas en dos días**.
2. **Sin tema.** El operador dice «cuidado hoy con la máquina» y termina. Eso no es una charla, es una despedida. Sin tema concreto la charla no existe. Regla: **si no tienes tema, pregunta al *brygadzista* diez minutos antes del turno qué ve él de inusual hoy**.
3. **Monólogo.** El operador habla, habla, habla. No hace ninguna pregunta. El equipo está en silencio. Después de tres charlas así, el ayudante deja de escuchar con atención y escucha por costumbre. Regla: **la pregunta de control es obligatoria, no opcional**.
4. **Sin firma.** La charla se celebró, el equipo arrancó a trabajar, el apunte se hizo después del almuerzo o nunca. La *PIP* lo trata como falta de charla. Regla: **firma en los 2 minutos siguientes al cierre de la charla, antes de arrancar la máquina**.
...
No siempre tienes tema. Hay días rutinarios, cuando la materia prima es la misma que ayer, la meteorología es estándar, el equipo no cambia, la máquina lleva una semana sin avería. No significa que la charla no se celebre. Significa que el tema lo sacas de **otra capa**: la repetición de una regla permanente.

Tienes en reserva diez temas recurrentes, entre los que eliges cuando no hay «tema del día»:

1. Rechazo de la cinta: distancia de 3 metros y dirección de evacuación.
2. Gestos de alarma (mano con cinco dedos = STOP; mano plana = reduce marcha).
3. Corte del suministro en caso de atasco.
4. Los seis EPI del operador de la P3.
5. Ubicación del botiquín y del lavaojos.
6. Punto de reunión en caso de alarma de incendio.
7. Contacto con el *mistrz zmiany* (panel de la entrada).
8. Tres grados de la materia prima y cómo reconocerlos a simple vista.
9. Medición de la humedad para el surtido del día (clase objetivo).
10. Procedimiento de la pausa del desayuno (quién apaga, quién vuelve primero).

Uno de los diez temas de reserva se repite cada semana o cada dos semanas. No es relleno. Es **una repetición que sostiene el hábito en el ayudante y en el operador junior**. El aprendizaje por repetición es la capa infravalorada del SSL en el aserradero polaco.
...
**Parte A. Reconocer la fuente del tema.** Para cada situación indica de cuál de las cinco fuentes (materia prima nueva, meteorología, avería del turno anterior, persona nueva, pedido especial) sacas el tema:
...
1. Enumera los cinco bloques de la charla de cinco minutos. Para cada uno di qué dices exactamente.
...
Durante los tres primeros días del M3 haz tres cosas:

- **Días 1 a 3, cada tarde:** apunta en la libreta dos palabras ancla para el tema de la charla del día siguiente. Marca la fuente del tema con un número (1 materia prima, 2 meteorología, 3 avería, 4 persona nueva, 5 pedido). Treinta segundos de tu día.
- **Día 1, por la mañana:** pídele a Marek que te haga de sombra en la primera charla. Él está a 3 metros detrás de ti, no interrumpe. Después de la charla pregúntale breve: «¿qué dije de más, qué de menos?». Apunta la respuesta en una frase.
- **Día 3, por la mañana:** dirige la charla sin Marek detrás (él ya está en su máquina). Mide con reloj cuánto duró. Apunta el resultado.

Para la l3 trae la libreta con tres temas, tres comentarios de Marek y una medición de tiempo. Empezaremos por ahí.
