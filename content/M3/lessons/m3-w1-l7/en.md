...
1. You know the three categories of **unusual conditions** in a Polish sawmill that require a modified start-up procedure: **frost** (hall temperature below +5°C or air at the machine below 0°C), **high humidity** (relative humidity above 85%), **long shutdown** (the machine has been off for more than 48 hours).
2. You perform the **winter start-up** of the P3 band saw according to the five-step procedure: warming up the gearbox, flushing the hydraulics, running the band without load, testing on a trial log, moving to production. You know the minimum times of each step and the manufacturer's limits.
3. You recognise the **risk of condensation** on the electrical systems of the saw: the moment when a cold machine heats up faster than the air around it, and moisture condenses on the controller boards. You know when the saw has to **stand in the hall for an hour** before you switch on the electronics power.
4. You read with understanding the **manufacturer's limits** for P3 (operating manual, chapter "Cold-weather start-up", Wood-Mizer LT70, pp. 47-52). You know that "-5°C" is the limit for standard oil, and below this the manufacturer requires winter oil ISO VG 32 or a full 45-minute warming-up procedure.
5. You recognise the risks specific to frozen raw material: the logs lay on the yard at -15°C, the wood at the core has a temperature of -8°C, a band entering the frozen moisture of the growth ring works in a completely different regime than in wood at a positive temperature. You know the practical rule: **frozen oak cuts like stone**, frozen pine like hardwood.
6. You know when to **refuse to start up** on the basis of art. 210 of the Polish Labour Code (from l3): if the unusual conditions exceed the manufacturer's limit, and the plant has not provided the proper oil, the proper heated hall, or the proper waiting time, refusal of work is your right and your duty.

## Content

### Three categories of unusual conditions

Unusual conditions for a self-reliant operator group into three categories. Each has different mitigations, but all three may occur together (in Poland in January that is typical, because weekend + blizzard + thaw humidity = frost + shutdown + condensation).

**Category 1: frost.** Hall temperature below +5°C or air at the machine below 0°C. For P3 (Wood-Mizer LT70), P2 (circular saw), P1 (multi-band SAB), the manufacturer permits operation down to -5°C after the full warming-up procedure. Below -5°C winter oil is required, or an extended 45-minute procedure.

**Category 2: high humidity.** Relative humidity above 85%. It appears most often in two situations: (a) early spring and autumn, when outside air at 15°C and 95% humidity enters the hall heated to 18°C and condenses on cold surfaces, (b) after flooding or prolonged rain. High humidity is a risk for electronics (condensation on the boards), for steel bands (fast corrosion), for the operator (icing on the floor, slipping).
...
### Manufacturer's limit for the P3 Wood-Mizer LT70

The operating manual (original in English, Polish translation in Marek's cabinet) has a chapter "Cold-weather operation", pages 47-52. Key limits:

- **Minimum start-up temperature with standard oil (ISO VG 46):** -5°C. Below this, winter oil (ISO VG 32) is required, or heating the hall to a higher temperature before starting.
- **Warming-up procedure:** minimum 15 minutes (steps 2-4 of the procedure above, that is, 10+5 minutes). Below -10°C externally and below +5°C in the hall the procedure is **45 minutes** with an additional "cycling" step (3 on-off cycles of the motor at 10 minutes each).
...
The second category (high humidity, above 85% RH) appears more often in spring and autumn than in winter. A characteristic situation: external temperature +12°C, air humidity 95% (after rain), hall heated to +18°C. The hall gate open for bringing in the logs. Humid air enters, condenses on the cold parts of the machines (especially the steel guide rails of the P2 circular saw).
...
>
> **P1. What can go wrong:**
> R1: the band snaps in the first log because of ice in the growth ring
> R2: the controller shows a condensation error at power-on
> R3: condensation on the floor, risk of slipping during an emergency movement
>
> **P2. How dangerous:**
> R1: medium (a snapped band 800 PLN + rejects + 40 min downtime)
> R2: high (cost of the controller 4,200 PLN + 4-8 hours downtime)
> R3: medium (operator fall, injury to the knee or wrist joint)
>
> **P3. What you do:**
> Mitigation of R1: the 15-minute procedure + the smallest trial log, feed rate at ½ standard
...
This is the other side of unusual conditions: **what to do** for the machine to survive the weekend well. Come back on Friday at 14:50, before you switch off. EGIDA standards:

1. **Grease the band guide rails** (protects against weekend rust). Machine oil, cloth, two minutes.
2. **Grease the carriage guide rails** (protects against binding in the cold). Grease LT-2, brush, three minutes.
3. **Leave the band slack** (reduce tension from 2300 PSI to 500 PSI). A band under full tension over the weekend remembers the stretching, the next start gives a wavy kerf.
4. **Switch off the main power** (the distribution cabinet switch). Energy saving + protection from mains surges.
...
Unusual conditions, three categories: **frost** (hall below +5°C, air below 0°C), **high humidity** (above 85% RH), **long shutdown** (above 48 hours). The fourth trigger for the OR-OP card from l6.

Winter start-up of P3: five steps, minimum 15 minutes (standard), 45 minutes (at -10°C and below). Hall inspection, warming up the gearbox, flushing the hydraulics, running the band without load, trial log.

Risk of condensation: cold controller + humid air = water on the boards. Mitigation: an hour of temperature equalisation or housing heating before the main power.

Frozen log: the band dulls faster (120 logs instead of 180), motor power higher (75-85% of rated), oak "cuts like stone", pine "like hardwood".
...
- **Winter start-up** (the procedure of starting up the saw in conditions of hall temperature below +5°C, minimum 15 minutes, five steps)
...
- **Long shutdown** (the machine has been off for more than 48 hours, requires a post-shutdown start-up procedure)
...
- **Condensation on electronics** (moisture condenses on cold controller boards when the machine heats up faster than the surrounding air)
...
- **Winter oil ISO VG 32** (a low-temperature oil for the gearbox, required below -5°C)
...
- **Trial log** (the smallest log in the batch, cut at half the standard feed rate, a start-up test before full production)
...
- **Relative humidity (RH)** (the percentage of water saturation in air at a given temperature, the limit is 90% for sawmill machine operation)
...
- **Mobile air heater** (50 kW, warms the hall from -6°C to +5°C in 90 minutes, EGIDA facility standard)
...
- **Frozen log** (a log with a core below 0°C, cuts at 20-30% higher resistance and faster band wear)
...
- **Enclosure temperature equalisation** (waiting an hour for the controller enclosure temperature to match the hall air temperature)
...
- **Standard oil limit (-5°C)** (the manufacturer's limit for ISO VG 46 oil in the P3 gearbox, below this winter oil is required)
...
**Part A. Three categories of unusual conditions:**

List the three categories of unusual conditions and for each give the threshold value (a number or a time) that triggers a modification of the start-up procedure.

1. Category: _______________ , threshold: _______________
2. Category: _______________ , threshold: _______________
3. Category: _______________ , threshold: _______________

**Part B. Five steps of the winter start-up:**

Write out the five steps of the winter start-up of P3 in order and give the minimum time of each step.

1. Step: _______________ , time: _______________
2. Step: _______________ , time: _______________
3. Step: _______________ , time: _______________
4. Step: _______________ , time: _______________
5. Step: _______________ , time: _______________

**Part C. Situational questions:**

1. You enter the hall on Monday at 6:00. The thermometer shows -7°C in the air at P3. What do you do? Justify through the manufacturer's limit.
2. Oak logs have been lying on the yard at -14°C since Friday. Marek says "today oak on the morning shift". Your answer? What professional, not panicky, argument?
3. The hall humidity shows 93% RH after overnight rain. What is the risk and what mitigation do you propose to Marek?
4. After the weekend you switched on the power of the controller right away (without heating the housing). What can happen and after what time will you see the effects?
5. How would you fill in the OR-OP card for a spring start-up after a long shutdown (humidity 88%, hall +6°C, 96 hours off after the holidays)?

**Part D. Preparing the machine for Friday evening:**

Write out the six tasks that a self-reliant operator does at the end of the Friday afternoon shift so that the machine survives the weekend in good condition. Explain for each one **why** it is done.
...
- **Pedagogical trap no. 3: winter start-up as bureaucracy.** Trainees from the "just switch on and go" tradition (especially from the former USSR, from small sawmills) may feel that 15 minutes of warming up is a waste of time. Economic argument: the gearbox 18,000 PLN vs 15 minutes a day = 3.5 hours a month = 45 hours a year. Three years of saved hours do not equal the price of the gearbox, but one broken gearbox is 18,000 PLN and two weeks of downtime. The maths is unambiguous.

- **Group discussion "your plant vs. EGIDA".** Ask the trainees how their plant does the winter start-up. Most will say: "it does not". Some: "only on Christmas". A few: "there is a procedure, but nobody follows it". This is the real picture of the sawmill market in Poland. Tell the trainees: "if your plant does not do it, **you do it**, this is your workstation".

- **Link to M1 l7 (safety in winter conditions):** M1 taught how to dress for winter in the sawmill, what to wear on your feet, how to protect your hands. M3 l7 teaches how to warm up the machine. Together: cold operator + cold machine = double risk. Warm operator + warmed-up machine = routine shift. Ask the trainees to go back to their M1 l7 notes the evening before M3 l7.

- **Link to M2 l5 (kerf quality):** M2 l5 taught how to recognise a wavy kerf as a symptom of band vibration. M3 l7 shows one of the **causes**: a cold band, cold oil, unbalanced warming. Symptoms from M2 have causes in the procedures from M3. Integration of modular knowledge.

- **Optional winter exercise (November-March):** organise a joint entry with the trainees into the hall at 6:00 on a Monday. Show them the winter start-up live, fill in the OR-OP card together. Two hours in the field are worth more than eight hours of theory. Off-season: show a video from the previous winter, or ask the trainees to collect such videos from their plants.
