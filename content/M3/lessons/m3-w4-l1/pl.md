...
```
Obchód P3 Wood-Mizer LT70 – 2026-06-18 07:08
=== Po wymianie łożysk kół dolnych (serwis WM 17.06 14:10) ===
- Plomba antymanipulacyjna WM-LT70-BB-2026-0142:     OK (czerwona, czysta, nienaruszona)
- Koło dolne napędowe: bicie wzrokowo 0,1 mm (norma <0,3)  OK
- Łożyska dźwięk:     suchy szum, bez mielenia         OK
- Smarownica łożysk: poziom pełny (Pan Krzysztof uzupełnił)  OK
- Taśma wczorajsza zdjęta, czeka świeża:
     stellite 38/10 TPI, nr ST-38-10-S14 (nowa kopertka)
- Prowadniki przód/tył:   czyste, bez kurzu, gumy OK
- Odciąg Nestro NE-18:    filtr zmieniony 16.06, ciśnienie OK
- LOTO po serwisie:       zdjęte 17.06 14:30 przez Pana Krzysztofa
- Stan hydrauliki posuwu: ciśnienie robocze 180 bar  OK
- E-STOP główny + dublowane: testowane ręcznie       OK
- Podłoga wokół P3: czysta, bez plam oleju            OK
Rozruch zezwolony.
```
...
Numer partii:       ZLE-2026-06-017 / BR-BR-06
Gatunek:            brzoza brodawkowata (Betula pendula)
Pochodzenie:        Nadleśnictwo Strzałowo, leśnictwo Wężewo, poręba 2026/03
...
Ilość desek:        78 szt.
 ...
 - krótsze 20×80×3850 (pień 4 pęknięcie mrozowe): 2 szt.
 - z oznaczeniem sęk (pień 2, literka S): 6 szt.
Objętość surowa:    0,505 m³

Przeznaczenie:       listwy wykończeniowe stolarka meblowa
Klient docelowy:    MebelPro Olsztyn (umowa ramowa UR/2025/108)
...
**Metoda pomiaru wilgotności dla partii** (wytyczna EGIDA § 4 regulaminu jakości reg.wew.05/2024, oparta o PN-EN 13183-2 „Wilgotność próbki tarcicy – oznaczenie metodą elektryczną oporową"):

1. Pomiar w **pięciu punktach** partii: narożniki górne (1, 2), narożniki dolne (3, 4), środek stosu (5).
2. Punkt pomiarowy: **15 cm od czoła deski** (bo czoło schnie szybciej, fałszywy wynik).
3. Głębokość igły: **1/3 grubości deski** (dla 20 mm = 6-7 mm).
...
Punkt 1 (narożnik L górny, deska nr 1):
   odczyt 1: 37,8%     odczyt 2 (+90°): 38,2%     odczyt 3 (-90°): 37,6%
   średnia: 37,9%
Punkt 2 (narożnik P górny, deska nr 20):
   odczyt 1: 38,1%     odczyt 2: 37,5%            odczyt 3: 38,3%
   średnia: 38,0%
Punkt 3 (narożnik L dolny, deska nr 59):
   odczyt 1: 38,5%     odczyt 2: 38,9%            odczyt 3: 38,2%
   średnia: 38,5%
Punkt 4 (narożnik P dolny, deska nr 78):
   odczyt 1: 38,0%     odczyt 2: 37,9%            odczyt 3: 38,4%
   średnia: 38,1%
Punkt 5 (środek stosu, deska nr 40, warstwa 2):
   odczyt 1: 38,3%     odczyt 2: 38,0%            odczyt 3: 37,8%
   średnia: 38,0%

ŚREDNIA PARTII:  38,1%
ROZRZUT:         0,6 pkt (37,9 do 38,5)  – bardzo niski, dobra jednorodność
...
Przyrząd:        Tanel ET-6 (kal. 2026-03-15, ważna 12 mies.)
Data pomiaru:    2026-06-18 12:10-12:25

Pkt 1 (narożnik L górny, deska 1):    37,9%
Pkt 2 (narożnik P górny, deska 20):   38,0%
Pkt 3 (narożnik L dolny, deska 59):   38,5%
Pkt 4 (narożnik P dolny, deska 78):   38,1%
Pkt 5 (środek stosu, deska 40):       38,0%

Średnia partii:  38,1%
Rozrzut:         0,6 pkt
Jednorodność:    DOBRA (zgodna z PN-EN 13183-2 pkt 7.4)
...
```
Deska 1: 20,1 × 80,3 × 4050 mm    wada: brak              klasa wstępna: A czysta
Deska 2: 20,0 × 80,1 × 4050 mm    wada: brak              klasa wstępna: A czysta
Deska 3: 20,2 × 79,9 × 4050 mm    wada: brak              klasa wstępna: A czysta
(...)
Deska 21 (z pnia 2): 20,0 × 80,2 × 4050    wada: sęk śr. 18 mm w 1/3 długości    klasa: B sęk
Deska 22: 20,1 × 80,0 × 4050        wada: sęk śr. 22 mm w 2/3 długości    klasa: B sęk
(...)
Deska 69 (z pnia 4): 20,1 × 80,2 × 3850    wada: czoło dolne surowe (cięte +20 mm)    klasa: B wymiar
Deska 70: 20,0 × 80,1 × 3850        wada: czoło dolne surowe (cięte +20 mm)    klasa: B wymiar
(...)
Deska 78: 20,2 × 80,0 × 4050        wada: brak              klasa wstępna: A czysta

ZESTAWIENIE WAD:
- klasa A (czyste, bez wad):     70 szt.  (deski 1-20, 27-57, 61-68, 71-78)
- klasa B (sęk):                  6 szt.  (deski 21, 22, 23, 24, 25, 26)
- klasa B (wymiar krótszy):      2 szt.  (deski 69, 70 długość 3850 mm)
- klasa C (zdeklasowane):        0 szt.
- odrzuty:                       0 szt.

ZESTAWIENIE WYMIARÓW:
Grubość:    min 20,0 / max 20,2 / śr. 20,10 mm (tolerancja docelowa ±0,5)
...
– Wilgotność: 38,1% średnia, rozrzut 0,6 pkt, jednorodna.                    OK.
– Wymiary: 20,10 grubość, 80,12 szerokość, długości 4050 lub 3850 z 2 szt.   OK.
...
**Po 90 minutach** (14:30) Pani Ania kończy. Wynik klasyfikacji:

```
KLASYFIKACJA (uzupełnienie KEP-001 przez klasyfikatora):
Metoda:  wizualna wg PN-EN 1611-1 (liściaste, klasa umowna C16)
Lupa:    Eschenbach 10×
Suwmiarka: Mitutoyo 500-196-30 (kal. 2026-02-01)

Klasy finalne:
- klasa A (czyste pełnowymiar):     70 szt. → C16 umowna
- klasa B (sęk zdrowy <25 mm):       6 szt. → C16 umowna (sęk klasyczny dopuszczalny)
- klasa B (wymiar krótszy 3850):    2 szt. → C16 umowna krótsza
- zdeklasowane:                      0 szt.
- odrzuty:                           0 szt.

Wydajność klasyfikacji:  100% partii przyjęte do C16 umowna
Czas klasyfikacji:         90 min (sprawne, dzięki gotowej KEP-001)

Podpis klasyfikatora:    Anna Kowalczyk, ITB-KLAS-247/2019
                         2026-06-18, 14:30
Pieczątka imienna:       [pieczątka zielona]
```
...
4. **Klasyfikacja** – moja pieczątka, data szkolenia ITB aktualnego, uwagi klasyfikacyjne.
5. **Podpisy** – **ja podpisuję w polu klasyfikatora**, Marek w polu sprzedawcy jako brygadzista, **Ty nie podpisujesz WZ**.
6. **Retencja** – 5 lat w archiwum EGIDA (kopia klienta + kopia w segregatorze ZLE-2026 + skan do systemu CRM)."*

*„Czemu ja nie podpisuję WZ, Pani Aniu?"*
...
*„**Najważniejsze pytanie**. Ja weryfikuję pierwsze 10 desek pełnie, potem wyrywkowo. Jeśli w 10 pierwszych mam 0 rozbieżności, przechodzę do wyrywki SPC. **Jeśli znajdę 1 rozbieżność w pierwszych 10, sprawdzam wszystkie 78 sama.** To jest moja polisa. Ale jeśli wyrywka daje zero, zaufanie operatora wysokie, **jestem współodpowiedzialna z Tobą za dane z KEP-001**. Dlatego moje szkolenie ITB w Poznaniu było między innymi o **weryfikacji danych operatora M3** – nowy punkt w PN-EN 14081-1 z grudnia 2025, że **klasyfikator ma obowiązek weryfikować dane wejściowe operatora przed podpisem WZ**."*

*„Więc dziś Pani mi zaufała."*
...
Sprzedawca:     EGIDA sp. z o.o., ul. Długa 42, 11-400 Kętrzyn
                NIP 8351234567, KRS 0000789123
                FSC-C112233 (100% Forest Stewardship Council)

Odbiorca:       DOM-STOL Warszawa sp. z o.o., ul. Wolska 128, 01-231 Warszawa
                NIP 1181234567
                Umowa ramowa: UR/2025/021

Data wydania:  2026-06-18
Data wystawienia: 2026-06-18
Numer zlecenia:  ZLE-2026-06-016
Numer partii:    DE-SZP-06

– – – Opis towaru – – –

Towar:         deski dębowe szypułkowe (Quercus robur) pod blaty stołów
Gatunek:       dąb szypułkowy
Wymiary:       32 × 205 × 4050 mm
Ilość:         48 szt. / 1,212 m³
Wilgotność:    35,8% świeża (przed suszeniem, odbiór do suszarni klienta)
Klasa:         klasa wizualna PN-EN 1611-1 A (blaty stolarka)
Wady:          brak wad istotnych; 3 szt. z sękiem zdrowym <15 mm (klasa A sęk)
Pochodzenie:   Nadleśnictwo Strzałowo, ściąłka 2026-06-10
FSC:           FSC-C112233 100%

– – – Klasyfikacja – – –

Klasyfikator:  Anna Kowalczyk
Uprawnienia:   ITB-KLAS-247/2019, ważne do 11.2027
Szkolenie:     PN-EN 14081-1 aktualizacja 16.06.2026 (cert. ITB/PK/2026/0427)
Metoda:        wizualna pełna + suwmiarka SPC (wyrywka co 3 deski)
Uwagi:         partia jednorodna, 0 rozbieżności przy weryfikacji

– – – Podpisy – – –

Klasyfikator:  Anna Kowalczyk, [pieczątka zielona ITB]
                                                    2026-06-18 godz. 14:30

Sprzedawca:    Marek Kowalski (brygadzista EGIDA)
                                                    2026-06-18 godz. 16:00

Odbiorca:      ___________________________    podpis osoby upoważnionej DOM-STOL

– – – Retencja – – –

Kopia 1:   klient (wraz z towarem)
Kopia 2:   segregator ZLE-2026-06 (archiwum EGIDA, 5 lat)
Skan:       CRM EGIDA (archiwum cyfrowe)
...
Dokumentacja: KEP-001 kompletna, przekazana Pani Ani 13:00, WZ nr EGIDA/2026/06/109
...
KEP-001 zawiera 4 sekcje obowiązkowe:

| Sekcja | Treść | Kto wypełnia |
|---|---|---|
| **Nagłówek** | Numer partii, gatunek, pochodzenie FSC, data ścinki, leżakowanie, data przetarcia, operator, asysta, ilość desek, objętość, przeznaczenie, klient, oczekiwana klasa | operator |
| **Pomiar wilgotności** | Metoda PN-EN 13183-2, przyrząd + kalibracja, 5 punktów pomiarowych (narożniki + środek), 3 odczyty na punkt, średnia partii, rozrzut, wniosek | operator |
| **Lista desek z wadami** | Numer deski, grubość × szerokość × długość, opis wady, klasa wstępna | operator |
| **Klasyfikacja** (puste dla operatora) | Metoda klasyfikacji, przyrządy weryfikatora, klasy finalne, uwagi, podpis + pieczątka klasyfikatora | **klasyfikator** uzupełnia |

Operator **podpisuje tylko swoje sekcje**, klasyfikator **podpisuje swoją sekcję**. Podpis operatora oznacza odpowiedzialność za **wierność pomiarów**, podpis klasyfikatora oznacza odpowiedzialność za **ocenę klasy**.

### Metoda pomiaru wilgotności (PN-EN 13183-2)

Norma **PN-EN 13183-2 „Wilgotność próbki tarcicy – oznaczenie metodą elektryczną oporową"** określa zasady pomiaru wilgotności tarcicy wilgotnościomierzem oporowym (jak Tanel ET-6 używany w EGIDA). Kluczowe wymogi:

1. **Minimum 5 punktów pomiarowych** dla partii do 100 desek, 10 punktów dla partii 100-500, powyżej 500 – 2% losowy wybór.
2. **Pozycja pomiaru** – 15 cm od czoła deski (czoło schnie szybciej), środek szerokości, głębokość igły = 1/3 grubości deski.
3. **3 odczyty na punkt** z obrotem o 90° – uśrednienie eliminuje lokalną niejednorodność włókien.
4. **Kalibracja przyrządu** – co 12 miesięcy (certyfikat zachowany w archiwum metrologicznym EGIDA).
5. **Dokumentacja pomiaru** – każdy punkt zapisany z wartością, **średnia partii + rozrzut** wyliczany automatycznie.

**Rozrzut < 1 pkt procentowego** = partia jednorodna, gotowa do jednego cyklu suszenia.
...
**PN-EN 1611-1 „Klasyfikacja wizualna tarcicy iglastej"** (z zastosowaniem „odpowiednim" do liściastych w umowach handlowych) definiuje 3 klasy wizualne:

| Klasa | Wady dopuszczalne | Zastosowanie |
|---|---|---|
| **A** (czysta) | brak lub pojedyncze zdrowe sęki < 10 mm, brak pęknięć | stolarka widoczna, blaty, meble |
| **B** (sęk) | sęki zdrowe do 40 mm, pęknięcia zamknięte < 30 cm długości | stolarka budowlana, więźba widoczna, deski podłogowe |
| **C** (zdeklasowana) | sęki wypadające, pęknięcia otwarte, sinizna | opakowania, budowa nie widoczna, palety |
...
| Zakres | Operator M3 | Klasyfikator ITB | Uwagi |
|---|---|---|---|
| **Pomiar wilgotności** | ✅ 5 punktów PN-EN 13183-2 | weryfikacja wyrywkowa | klasyfikator sprawdza co 5 deska SPC |
| **Pomiar wymiarów** | ✅ każda deska suwmiarka + miara | weryfikacja pierwszych 10 desek pełna, potem SPC | różnica między pomiarami max 0,3 mm dopuszczalna |
| **Identyfikacja wad** | ✅ wzrokowo z oznaczeniem ołówkiem | ✅ lupą 10× pełna inspekcja | klasyfikator **dopełnia** operatora |
| **Ocena klasy PN-EN 1611-1** | klasa wstępna A/B/C | ✅ **klasa finalna** | tylko klasyfikator decyduje |
| **Ocena klasy wytrzymałościowej** | brak | ✅ **tylko klasyfikator ITB** | iglaste PN-EN 14081-1, liściaste PN-EN 13366 |
| **Podpis KEP-001** | ✅ sekcje operatorskie | ✅ sekcja klasyfikatora | podwójny podpis, dwie odpowiedzialności |
| **Podpis WZ** | ❌ operator NIE podpisuje | ✅ **klasyfikator + brygadzista** | WZ = certyfikacja zewnętrzna |
| **Odpowiedzialność cywilna wobec klienta** | pośrednia (wobec EGIDA) | ✅ bezpośrednia (OC klasyfikatora 250 000 zł) | klasyfikator ubezpieczony |
| **Ubezpieczenie OC zawodowe** | nie wymagane dla M3 | ✅ obowiązkowe (warunkiem licencji ITB) | reguła ITB od 2019 |

**Zasada kanoniczna** (Pani Ania):
> Operator mierzy, klasyfikator klasyfikuje. Operator podpisuje to, co zmierzył. Klasyfikator podpisuje to, co zdecydował. Podpisz tylko to, za co odpowiadasz.

### Format WZ (Wydanie Zewnętrzne)

**Wydanie Zewnętrzne** to dokument wyjścia towaru z magazynu EGIDA do klienta. Ma 6 sekcji obowiązkowych:

1. **Nagłówek** – dane EGIDA (NIP, KRS, FSC-C112233), numer WZ, data, numer zlecenia, numer partii.
2. **Dane klienta** – pełna nazwa, NIP, adres, umowa ramowa (jeśli jest), osoba upoważniona do odbioru.
3. **Opis towaru** – gatunek (łacińska nazwa w nawiasie), wymiary, ilość, objętość, wilgotność, klasa, wady, pochodzenie FSC.
4. **Klasyfikacja** – klasyfikator, uprawnienia (numer licencji ITB, data ważności), metoda, przyrządy, uwagi.
5. **Podpisy** – **klasyfikator** (pieczątka ITB zielona), **sprzedawca/brygadzista**, **odbiorca** (miejsce na podpis przy odbiorze).
6. **Retencja** – 5 lat w archiwum EGIDA, kopia klienta, kopia segregator ZLE, skan CRM.

**WZ wychodzi z klientem i wraca z jego podpisem** – dowód wydania towaru. Podstawa prawna retencji: § 12 ust. 3 regulaminu jakości reg.wew.05/2024 + ogólnie art. 74 ustawy o rachunkowości (5 lat dla dokumentów magazynowych).

### Pedagogika: dokumentacja przed klasyfikacją

**Najczęstszy błąd początkujących operatorów M3**: wypełnianie KEP-001 **po fakcie** (wieczorem, „z pamięci", retrospektywnie).

**Dlaczego to błąd**:
1. **Pomiar wilgotności jest czasowy** – wilgotnościomierz odczytuje aktualny stan, a wilgotność zmienia się z dnia na dzień (tarcica traci 1-2% dziennie na hali w cieple). Pomiar „wieczorem" jest **innym stanem** niż pomiar „rano".
2. **Wady wzrokowe zmieniają się** – deski leżą na stosie, niektóre skryte w warstwach, „z pamięci" zapomina się o sękach w środku stosu.
...
- **Dokumentacja dodaje 1 godzinę do dnia**, ale **odcina 90 minut klasyfikatorowi** = **netto -30 minut dla całego tartaku**.
- **Pomiar 78 desek + wilgotność w 5 pkt = 75 minut pracy** (z pomocnikiem zapisującym).
- **KEP-001 wypełnia się w trakcie pomiarów**, nie retrospektywnie.
- **Operator podpisuje KEP, nie WZ** – granica certyfikacji.
- **3 różne dokumenty, 3 różne odpowiedzialności**: KEP (operator), klasyfikacja wewnątrz KEP (klasyfikator), WZ (klasyfikator + brygadzista).
- **Reputacja operatora dokumentalnego** buduje się przez **serię dobrych dokumentów**, nie przez jeden.
- **Dodatek 3% za 6 miesięcy zero-błędnej dokumentacji** jest w regulaminie – **pieniądze za rzetelność**.
...
1. Co to jest **KEP-001** i czym różni się od WZ? Który dokument wychodzi do klienta, a który zostaje wewnątrz tartaku?
2. Ile punktów pomiarowych wilgotności wymaga **PN-EN 13183-2** dla partii 78 desek? Dlaczego akurat 5?
3. Dlaczego pomiar wilgotności wykonuje się **15 cm od czoła** deski, a nie na samym czole?
4. Co to znaczy **rozrzut 0,6 pkt** i co mówi o partii?
5. Jaka jest różnica między klasą **A**, **B** a **C** wizualną wg PN-EN 1611-1?
6. Co to jest **klasa C16 umowna** i dlaczego MebelPro Olsztyn zadowala się tą klasą dla listew?
7. **Kto podpisuje WZ**, a kto KEP-001? Dlaczego operator M3 nie podpisuje WZ?
8. Dlaczego Pani Ania **sprawdziła pełnie tylko pierwsze 10 desek**, a resztę wyrywkowo? Jak ta metoda się nazywa?
9. Co to jest **dodatek 3% za pracę dokumentacyjną** w EGIDA i po jakim okresie operator może go otrzymać?
10. Jaka jest **retencja KEP-001** i WZ w archiwum EGIDA? Która podstawa prawna?
