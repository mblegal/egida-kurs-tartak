...
1. You know the five steps of the procedure after a coworker's accident: **secure yourself, stop the machines, give first aid, call the services, secure the scene**. You know why the first step is to secure yourself, not to help the victim.
2. You understand art. 234 § 1 and § 2 of the Polish Labour Code: the employer's duties after an accident, and when the PIP (the *Panstwowa Inspekcja Pracy*, State Labour Inspectorate) and the prosecutor must be notified without delay.
3. You understand art. 209¹ of the Polish Labour Code: the employer designates workers to give first aid. In the EGIDA sawmill you are one of them, if you have completed the first-aid course (as part of M1 l8). You know the numbers 112 and 999, and you know which of them to pick.
4. You can pass the alert to the medical dispatcher in the format the services expect: where, what happened, how many people injured, type of injuries, who is calling.
5. You secure the accident scene so that the protocol establishing the circumstances and causes is based on the real state, not on the "tidied-up" state. You know what you **are** allowed and **are not** allowed to move before the shift master arrives.
6. You know what the post-accident protocol under art. 234 § 3 (10-year retention) looks like, and what your role as a witness in it is.

## Content

### Five steps after an accident, in order

The procedure after a coworker's accident has five steps. The order is rigid, like the STOP procedure from l4, with the difference that here the stakes grow at every step. Step one decides whether there will be two injured people instead of one. Step two decides whether there will be further events in the chain. Step three decides whether the victim survives. Step four decides how quickly help arrives. Step five decides how the protocol will end for the plant and for the PIP.

**Step 1: secure yourself.** Before you run to your colleague, check in three seconds: is the scene safe for you. Is the machine next to your colleague still running? Is there electricity, oil on the floor, broken glass, a hot element? If the scene is dangerous, your help turns you into the second victim. Two victims means a doubled response time from the services, half as much help for the first victim, a drastically worse outcome.

**Step 2: stop the machines.** Yours and his. Your machine is running (you are standing next to it), he is no longer operating his (he is lying, sitting, holding his wound). First STOP on yours (the rule from l4, a reflex, seconds). Then STOP on his, if it is running (you approach, you use the **emergency** stop from a distance, you do not get close to moving parts).

**Step 3: first aid.** In line with what you learned in M1 l8: assessment of the state, stopping bleeding, recovery position, stabilisation of limbs, observation of breathing. You do not diagnose. You keep the victim alive until the services arrive.

**Step 4: calling the services.** 112 (the universal emergency number) or 999 (the medical emergency service). In a sawmill with a production line you can call from the workstation phone, from a mobile, or activate the in-plant alarm, which notifies the reception, and reception calls 112.
...
The number 112 is **universal** and connects you to a dispatcher who decides which services to send (ambulance, fire, police). The number 999 is **directly the ambulance service**, without an intermediary. Both are free of charge, both work from any phone (landline, mobile, even without a SIM card).

In a sawmill **use 112**, because an event at a machine usually requires calling the fire service at the same time (fire risk, especially at electric motors) and possibly the police (if the threat requires help in securing the area). 112 handles everything with one call. 999 is the alternative if 112 does not answer within the first fifteen seconds.
...
### Art. 234 of the Polish Labour Code: what the plant has to do

Art. 234 of the Polish Labour Code imposes four duties on the employer after a workplace accident. The full wording of the key paragraphs:

**Art. 234 § 1 of the Polish Labour Code:**

> "In the event of a workplace accident, the employer is obliged to undertake the necessary measures to eliminate or limit the hazard, ensure first aid is provided to the injured persons and that the circumstances and causes of the accident are established in the prescribed manner, and apply appropriate measures to prevent similar accidents."

**Art. 234 § 2 of the Polish Labour Code:**

> "The employer is obliged to notify without delay the competent district labour inspector and the prosecutor of a fatal, severe or collective workplace accident, and of any other accident which caused the said consequences and is related to work, if it may be classified as a workplace accident."

**Art. 234 § 3 of the Polish Labour Code (retention):**

> "The employer is obliged to keep the protocol establishing the circumstances and causes of the workplace accident, together with the remaining post-accident documentation, for 10 years."

**Art. 234 § 4 of the Polish Labour Code:**

> "The costs related to the establishment of the circumstances and causes of workplace accidents are borne by the employer."

Three things matter operationally for you.

**First, the duty to notify PIP and the prosecutor (art. 234 § 2).** The accident with Murat may, but does not have to, be "severe" in the meaning of the law (criterion: an injury causing permanent damage to the body or long-lasting detriments to health, the definition in the Regulation of the Council of Ministers on establishing the circumstances of accidents). The qualifying decision belongs to the plant OSH inspector (Jaroslaw) after consultation with the treating physician. If the accident is qualified as "severe", Jaroslaw **must** notify PIP and the prosecutor without delay. If not, the qualification stays internal.

**Second, the 10-year retention (art. 234 § 3).** Your name as a witness will land in a document that will stay in the EGIDA archive until April 2036. Your name will also be in the register of workplace accidents that the OSH inspector keeps for PIP. This is not a minus for you, it is the standard. A witness's documentation is part of his legal status.

**Third, criminal liability for failure to notify (art. 283 § 2 pt 6, from l3).** If the accident is severe and the plant does not report it to PIP, a fine from 1,000 to 30,000 PLN. Marek and Jaroslaw know this. It does not concern you directly (you are not "responsible for the state of OSH" in the meaning of art. 283 § 1), but your testimony is a documentation tool that protects Jaroslaw and the plant.

### Art. 209¹ of the Polish Labour Code: designated first-aid workers

Art. 209¹ § 1 of the Polish Labour Code states that the employer is obliged to designate workers for:
...
There are situations in which the first aid of a self-reliant operator is **limited** or **inappropriate**. You have to recognise them.

**Situation 1: electric shock.** If the victim is electrocuted (clamp on the blade, live wire, short circuit in the motor), you **do not touch** him until the power is disconnected. Touching a person under voltage turns you into the second victim. Disconnecting the power: the service switch, and if it does not work, the main switch of the hall (at EGIDA: at the entrance to the server room, Marek knows where).

**Situation 2: unconsciousness with suspected spinal injury.** The victim is lying, unconscious, but breathing. You **do not move** the head, do not roll him onto the side, do not sit him up. You stay next to him, stabilise the head with your hands along the axis of the body (if you know how, from M1 l8), wait for the services. An incorrect recovery position with a damaged spine can mean permanent paralysis.

**Situation 3: arterial bleeding (spurting rhythmically from the wound).** Your personal dressing may not be enough. In the EGIDA kit you have a **tourniquet (CAT, Combat Application Tourniquet)**, which is mandatory for arterial bleeding from a limb. You apply it 5 to 7 cm above the wound, tighten it until the bleeding stops, write on it the time of application (the marker is attached to the dressing). If you do not have a CAT, you press with your palm with all your strength until the services arrive.

**Situation 4: suspected amputation.** If a finger, hand, or part of a limb has been severed, you wrap the **severed part** in a sterile dressing, put it in a plastic bag, and that bag into a second bag with ice (**never ice directly on the tissue**). You dress the stump with a pressure bandage. The severed part travels with the victim to the hospital in the bag, microsurgery may be possible up to 6 hours from the injury. In M2 l8 you went through this scenario in detail.
...
### What the self-reliant operator does not do

The boundary of your role is important. A self-reliant operator is **not**:

- **A doctor.** Your first aid is keeping the victim alive until the services arrive, not treating. Do not give medication (even if the victim asks), do not make diagnoses, do not try to "set" broken bones.
- **An OSH inspector.** You do not establish the causes of the accident, that is Jaroslaw's role. You write only **what you saw** and **what you did**.
- **A representative of the plant before PIP.** Do not talk with the PIP inspector about plant policy, budgets, staffing decisions. You speak only about the event you witnessed.
- **A judge of coworkers.** You do not assess whether Murat made a mistake. You say what you saw (the push stick on the floor), but you do not pronounce who was guilty. Pronouncement is the role of the post-accident team, sometimes of the court.
- **A therapist.** Emotional support for coworkers in the days after the accident is human, but remember that the plant has a professional psychologist (at EGIDA as part of the employee programme) for witnesses of severe events. Offer a visit, do not replace the psychologist.

### Summary of lesson five

Five steps after an accident: secure yourself, stop the machines, first aid, call the services, secure the scene. The order is rigid, each step a matter of seconds or single minutes.

Art. 234 of the Polish Labour Code: employer duties after an accident (first aid, establishing causes, prevention, notifying PIP and the prosecutor in severe accidents), 10-year retention of the protocol, costs on the plant's side.

Art. 209¹ of the Polish Labour Code: workers designated for first aid. At EGIDA in M3 you are one of them, if you have the course.

The 112 alert: seven elements in one sentence. Who is calling, where, what, how many victims, injuries, condition of the victim, what the caller is doing. Seconds count.
...
- **Pierwszy swiadek** (osoba, ktora jako pierwsza dotarla do miejsca wypadku, pelni role ratownika i dokumentalisty)
  - en: first witness (the first person to reach the accident site, acts as responder and documenter)
  - es: primer testigo (la primera persona en llegar al lugar del accidente, actua como socorrista y documentador)
  - uk: перший свідок (перша особа, що дісталася до місця нещасного випадку, виконує роль рятувальника та документатора)
- **Protokol ustalenia okolicznosci i przyczyn wypadku** (formalny dokument zespolu powypadkowego, retencja 10 lat)
  - en: accident circumstances and causes protocol (formal document of the accident investigation team, 10-year retention)
  - es: acta de determinacion de circunstancias y causas del accidente (documento formal del equipo de investigacion, conservacion 10 anos)
  - uk: протокол встановлення обставин і причин нещасного випадку (офіційний документ комісії з розслідування, зберігання 10 років)
- **Uproszczone LOTO** (szybkie LOTO w sytuacji ostrej: klodka zakladowa teraz, tabliczka imienna pozniej)
  - en: simplified LOTO (quick lockout in an emergency: facility padlock now, named tag later)
  - es: LOTO simplificado (bloqueo rapido en emergencia: candado de fabrica ahora, tarjeta nominal despues)
  - uk: спрощене LOTO (швидке блокування в екстреній ситуації: заводський замок зараз, іменна табличка пізніше)
- **112** (europejski uniwersalny numer alarmowy)
  - en: 112 (European universal emergency number)
  - es: 112 (numero europeo universal de emergencia)
  - uk: 112 (європейський єдиний номер екстреної допомоги)
- **999** (polski numer pogotowia ratunkowego)
  - en: 999 (Polish medical emergency number)
  - es: 999 (numero polaco de urgencias medicas)
  - uk: 999 (польський номер медичної швидкої допомоги)
- **Art. 234 Kodeksu pracy** (obowiazki pracodawcy po wypadku, retencja dokumentacji 10 lat)
  - en: art. 234 of the Polish Labour Code (employer duties after an accident, 10-year documentation retention)
  - es: art. 234 del Codigo de Trabajo polaco (obligaciones del empleador tras accidente, conservacion de documentacion 10 anos)
  - uk: ст. 234 Кодексу праці Польщі (обов'язки роботодавця після нещасного випадку, зберігання документації 10 років)
- **Art. 209¹ Kodeksu pracy** (obowiazek pracodawcy wyznaczenia pracownikow do pierwszej pomocy)
  - en: art. 209¹ of the Polish Labour Code (employer's duty to designate first-aid workers)
  - es: art. 209¹ del Codigo de Trabajo polaco (obligacion del empleador de designar trabajadores para primeros auxilios)
  - uk: ст. 209¹ Кодексу праці Польщі (обов'язок роботодавця призначити працівників для надання першої допомоги)
- **CAT (Combat Application Tourniquet)** (opaska zaciskowa przy krwotoku tetniczym, zapisana godzina zalozenia)
  - en: CAT (Combat Application Tourniquet, a tourniquet for arterial bleeding, application time recorded on it)
  - es: CAT (Combat Application Tourniquet, torniquete para hemorragia arterial, hora de colocacion anotada)
  - uk: CAT (Combat Application Tourniquet, джгут при артеріальній кровотечі, час накладання записаний)
- **Zespol powypadkowy** (trzyosobowy zespol ustalajacy okolicznosci i przyczyny wypadku)
  - en: accident investigation team (three-member team establishing the circumstances and causes of the accident)
  - es: equipo de investigacion del accidente (equipo de tres miembros que determina las circunstancias y causas del accidente)
  - uk: комісія з розслідування нещасного випадку (тричленна комісія, що встановлює обставини і причини нещасного випадку)
- **Skala AVPU** (szybka ocena przytomnosci: Alert, Voice, Pain, Unresponsive)
  - en: AVPU scale (quick consciousness assessment: Alert, Voice, Pain, Unresponsive)
  - es: escala AVPU (evaluacion rapida de la consciencia: Alert, Voice, Pain, Unresponsive)
  - uk: шкала AVPU (швидка оцінка свідомості: Alert, Voice, Pain, Unresponsive)

## Check yourself

**Part A. Five steps, in order:**

Fill in the five steps of the procedure after a coworker's accident and provide for each **one concrete task**:

1. _____________ : concrete task - ____________
2. _____________ : concrete task - ____________
3. _____________ : concrete task - ____________
4. _____________ : concrete task - ____________
5. _____________ : concrete task - ____________

**Part B. The 112 alert, seven elements:**

Write out the seven elements of the alert to the 112 dispatcher in the correct order:
...
1. You heard a shout from the neighbouring machine. Why are the first three seconds the most important, even though every second delays the rescue? Refer to the PIP statistic from the lesson.
2. The victim is conscious, but the bleeding is clear and continuous. What does "first aid" mean in your performance, and what do you **not** do?
3. Explain the difference between the numbers 112 and 999 and when you would pick each of them. Why is 112 usually the better choice in a sawmill?
4. After the ambulance leaves, another operator wants to tidy up the scene ("because tomorrow we have to work"). How do you respond? Refer to art. 234 § 1 and § 3 of the Polish Labour Code.
5. What is the boundary of your role as a witness in a conversation with a PIP inspector? What do you talk about, and what do you not?

**Part D. Witness testimony:**

Write your own testimony (8 to 12 lines) for a hypothetical accident in your plant (may be imagined). Check that it contains: identification data, the time, what you saw, what you did (in order), calling the services, a statement on not changing the state of the scene, a signature.

## Link to practice

Over the next three days in your sawmill:

- Find the **board of workers designated for first aid** (in the changing room or at the entrance to the hall). Count how many people and check who is nearest to your saw. If it is not you, find out when the next in-plant first-aid course will be.
- Check your **personal first-aid kit** (the pocket one). Is it in your jacket? Do you have a dressing, a CAT, gloves, a plastic bag? If anything is missing, report it to Marek.
- Write down in your notebook the **emergency numbers**: 112, 999, the internal number of the EGIDA reception, the number of the shift master, the number of the OSH inspector Jaroslaw. If an event requires a phone call, you do not search for numbers under stress.
- Do a **mental review** of your saw: where is the red emergency mushroom, where is the main switch, where is the LOTO overlay, where are the spare padlocks. That is one minute in the day, which you pay back in seconds during an accident.
- In the next conversation with Marek ask about the **last accident at EGIDA**. Not as curiosity, as reflection. Ask: "what happened, what was hard, what did you take away from it". The answer will tell you more about the plant than a year of production work.

On Monday, in l6, we move to the technical block: risk assessment at a new workstation. Today's lesson was emotionally heavy, but the legal foundation and the procedures stay with you. In l6 we use that foundation for a different task: anticipating risk **before** it materialises.
...
- **The question of migrant status at an accident:** if in the group there are people with the fear "what will happen to me if I am a witness and a PIP inspector comes", assure them: your role as a witness is **protected**. Art. 234 § 2 of the Polish Labour Code concerns the employer's duties, not the witness. The witness gives truthful testimony, nothing more. Migrant status, residence card, employment contract are not subjects of the post-accident protocol. The protocol concerns the fact you witnessed. Nothing more.
- **After lesson l5:** it is worth the trainer checking his own emotional state. The lesson is heavy and the trainer carries its weight as much as the trainees. If the trainer himself went through a similar accident in his career, it may be a moment to share in a measured way (fact, not a story). The trainer's authenticity builds the group's trust, but the trainer is not a patient, so he does not turn the lesson into his own therapy.
