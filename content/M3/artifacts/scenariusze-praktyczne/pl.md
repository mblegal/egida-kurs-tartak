---
id: m3-scenariusze-praktyczne
faza: 4
typ: role-play
język: pl
odbiorca: trener / prowadzący kurs
---

# Scenariusze praktyczne M3: 8 rozbudowanych role-play z rubrykami 6-kryteryjnymi

## Przeznaczenie

Zestaw **8 rozbudowanych scenariuszy praktycznych** (role-play w parach lub trójkach) do wykorzystania przez trenera Fundacji EGIDA jako **dodatkowe egzaminy próbne** przed właściwym egzaminem praktycznym solo (samodzielna zmiana 8 godzin na P3 LT70, dąb FSC 12 m³ Bouwhout van Doorn, termin +14 dni od testu teoretycznego l8).

Każdy scenariusz **mapuje się na jedno z 6 kryteriów rubryki** egzaminu solo (kryteria 1-6) lub jest **integracyjny** (scenariusze 7-8 obejmują 4-5 kryteriów jednocześnie).

| Scenariusz | Główne kryterium rubryki | Wsparcie kryteriów | Aktywowane zasady M3 |
|---|---|---|---|
| 1. „KAO-001 z Adrianem na granicy 18/25" | 4 dokumentacja | 6 komunikacja | Z6 nadzór + Z3 dokumentacja |
| 2. „Decyzja parametryczna KDP-001 dla Bouwhout ±1 mm" | 2 KDP | 1 BHP + 4 dokumentacja | Z2 KDP + Z4 ekonomika |
| 3. „Nadzór Adriana z 3 błędami w trakcie cięcia" | 6 komunikacja | 1 BHP + 4 dokumentacja | Z6 nadzór + Z3 dokumentacja |
| 4. „Diagnoza usterki przez 3 zmysły LT70 bicie koła" | 5 reakcja na incydent | 1 BHP + 6 komunikacja | Z7 diagnoza + Z1 granica |
| 5. „Eskalacja granicy zewnętrznej do Wood-Mizer" | 5 reakcja na incydent | 6 komunikacja + 4 dokumentacja | Z1 granica + Z3 dokumentacja |
| 6. „Reklamacja klienta Dom-Bud telefoniczna z KC" | 6 komunikacja | 4 dokumentacja | Z5 KC + Z3 dokumentacja |
| 7. INTEGRACYJNY „Cała zmiana solo z incydentem" | 1+2+3+4+5+6 razem | wszystkie | Z1-Z8 wszystkie |
| 8. INTEGRACYJNY „Audyt FSC w trakcie zmiany nadzorczej" | 4+5+6 + 2 | większość | Z3 + Z6 + Z1 + Z5 |

**Format sesji**. Każdy scenariusz **45-75 minut** (15-20 min brief + 25-35 min wykonanie + 10-15 min debriefing). 4 scenariusze (1-4) w **tygodniu 4 przed testem l8** + 4 scenariusze (5-8) w **2 tygodniach między testem teoretycznym a egzaminem solo**.

**Dlaczego PL only**. Scenariusze prowadzi polski trener z grupą migrantów, którzy znają już 4 języki kursu z lekcji M1+M2+M3. Trening praktyczny **musi być w polskim** (to język instrukcji, dokumentacji i pracy w tartakach polskich). Dokument jest narzędziem trenera, nie kursanta.
...
- Common mistakes M3 + rozszerzenia trudności

**Uwaga o bezpieczeństwie**. Niektóre scenariusze symulują sytuacje z realnymi maszynami. Pilarki LT30/LT70 **nigdy nie uruchamiane na pełnych obrotach w symulacji**, tylko jałowo lub statycznie. Wózek widłowy (jeśli używany w scen. 4) tylko na niskich obrotach pod nadzorem trenera z UDT. Komora suszarni (scen. 5) symulowana panelem dydaktycznym, nie rzeczywistą.

## Lista rekwizytów do wszystkich 8 scenariuszy

Trener przygotowuje raz przed cyklem M3:

- **Puste formularze**: 15 × KDP-001, 15 × KS-001, 15 × KKS-001, 15 × KAO-001, 8 × KEP-001, 8 × EGIDA-RZ-001, 8 × EGIDA-PZ-001, 8 × EGIDA-RPW-001
- **Cenniki tarcicy 2026**: sosna C24 1700 zł/m³, dąb C24 2800 zł/m³, buk C24 2400 zł/m³, dąb FSC eksport +15% (do scen. 2, 6, 8)
- **Dyspozycje DP-2026-XX-XXX**: 8 sztuk, każda dla jednego scenariusza, ze szczegółami klienta i wymagań
- **Etykiety pakietów**: SO-DĄB-FSC-..., SO-SW-A-..., SO-BUK-FSC-... (po 5 sztuk każda)
- **Plakaty pomocnicze**: 8 zasad M3 (A2 plakat na sali), 7 typów usterek z granicą operator/UR/serwis (A3 obok stanowiska), tabela kosztów tartaku EGIDA (A3)
- **Druki bilingualne KC**: art. 556, 556¹ § 4, 560 § 1, 560 § 4, 561 § 3, 563 § 1 w 4 językach (PL/EN/ES/UK)
- **Tabele ROI kariery**: UDT+SEP, BTM, UPP z liczbami z l6 T4
- **Telefon symulacyjny** (atrapa lub stary smartfon na trybie samolotowym dla rola-play telefonicznych)

---

## Scenariusz 1: „KAO-001 z Adrianem na granicy 18/25" (kryterium DOKUMENTACJA)
...
**Sytuacja wyjściowa**. Adrian po 5 zmianach: kryterium 1 BHP = 4 (raz zapomniał ochronniki), 2 parametry KDP = 3 (trzy błędy: prędkość, prowadnice, napięcie), 3 technika = 4, 4 sortowanie = 4, 5 dokumentacja = 3 (raz pisał ołówkiem). **Suma 18/25**, zakres warunkowej (17-19/25).
...
- **Kryterium 4 dokumentacja (główne, 0-4)**:
  - 4 = KAO-001 wypełniona kompletnie + uzasadnienie pisemne 4-6 zdań cytujące regulamin § 8 + plan weryfikacji za 7 i 14 dni
  - 3 = KAO-001 kompletna + uzasadnienie krótsze (2-3 zdania) bez cytatu regulaminu
  - 2 = KAO-001 z lukami (np. brak planu weryfikacji)
  - 1 = KAO-001 z błędem oceny (zawyżona pełna 22/25 zamiast 18)
  - 0 = brak KAO-001 lub fałszerstwo (przyznanie pełnej z 18 bez uzasadnienia)
- **Kryterium 6 komunikacja (wsparcie, 0-4)**:
  - 4 = z Adrianem ton pedagogiczny + jasne wyjaśnienie dlaczego warunkowa nie jest karą; z Markiem profesjonalna obrona decyzji
  - 3 = jeden z dwóch elementów, drugi przeciętny
  - 2 = oba elementy słabe
  - 1 = ulega Adrianowi lub Markowi częściowo
  - 0 = ulega presji obu, daje pełną z 18/25

### Common mistakes M3

- Zaokrągla 18 → 20 „bo dobry chłopak" (fałszerstwo)
- Daje pełną mimo regulaminu, „bo brygadzista poparł"
- Daje warunkową ale bez planu weryfikacji za 7/14 dni
- Pisze uzasadnienie zbyt krótkie („18/25 = warunkowa") bez kontekstu pedagogicznego
- Pomija cytat regulaminu § 8 (audytor pyta, dlaczego warunkowa)
...
## Scenariusz 2: „Decyzja parametryczna KDP-001 dla Bouwhout ±1 mm" (kryterium KDP)
...
**Dla kursanta** (handout A):
- Dyspozycja DP-2026-06-026 z polem „tolerancja ±1 mm" wyraźnie zaznaczonym
- Pusta KDP-001 (5 parametrów: schemat, taśma, napięcie, prędkość, prowadniki)
- Etykieta pakietu SO-DĄB-FSC-20260620-006 (dąb klasy C30 6 m³)
- Tabela ciśnień napinania Wood-Mizer LT70 (z l1 T3 M3, kursant zna)
- Tabela typów taśm: stellite 7/8-A13, stellite 9/9-A15, stopowy STD-22

**Dla trenera**:
- Klucz parametrów oczekiwanych dla tej dyspozycji:
  - **Schemat**: B quarter sawing (lepszy stabilność wymiarowa dla ±1 mm + dąb klienta meblarsko-budowlanego)
  - **Taśma**: stellite 9/9-A15 (większa precyzja dla wąskich tolerancji)
  - **Napięcie**: 2400-2500 PSI (górna granica dla dębu, stabilność)
...
DP-2026-06-026 (z pułapkami), pusta KDP-001, etykieta pakietu, tabele ciśnień + typów taśm, telefon symulacyjny (do raportowania Markowi).
...
- **Kryterium 2 KDP-001 (główne, 0-4)**:
  - 4 = wszystkie 5 parametrów poprawnych z uzasadnieniem pisemnym + złapanie obu pułapek + opóźnienie startu jeśli potrzebne
  - 3 = 4 z 5 parametrów + uzasadnienie + 1 pułapka złapana
...
- Wybór schematu A „bo szybszy" bez analizy klienta
- Niezauważenie ciśnienia 2200 z poprzedniego cyklu (start z błędnym parametrem)
- Wpisuje parametry „bo tak Marek robił", bez własnego uzasadnienia
- Uruchamia o 7:00 z niekompletną KDP („dokończę w trakcie")
- Pomija dopisek „meblowo-budowlany hybrydowy"
...
## Scenariusz 3: „Nadzór Adriana z 3 błędami w trakcie cięcia" (kryterium KOMUNIKACJA)
...
2. **Minuta 12**: Adrian sprawdza prowadnice, raportuje 4,2 mm (powinno być 3 mm dla taśmy stellite 7/8). Adrian: „chyba OK, bliskie".
...
- **Kryterium 6 komunikacja (główne, 0-4)**:
  - 4 = wszystkie 3 błędy skorygowane w 60 s + ton pedagogiczny + nieskorygowana różnica stylu
  - 3 = 2 z 3 błędów + ton OK + różnica stylu nieruszana
...
- Czeka aż Adrian sam zauważy błąd („pedagogika odkryta") – propagacja błędu, ryzyko jakości
- Koryguje wszystko po sesji, nie w trakcie („nie chciałem mu przerywać")
- Koryguje też różnicę stylu (mikrozarządzanie)
- Ton krytyczny lub agresywny (Adrian zamknie się, w przyszłych zmianach unika konsultacji)
- Ton nadmiernie miły („Adrian, może spróbujesz...") – nie czytelny jako korekta merytoryczna
...
## Scenariusz 4: „Diagnoza usterki LT70 przez 3 zmysły – bicie koła 0,8 mm" (kryterium REAKCJA NA INCYDENT)
...
- **Sygnał 2 (słuch, minuta 5)**: trener odtwarza nagranie nierównomiernego stuku łożyska co 0,5 s (telefon głośnik) lub opisuje słownie „słyszysz dźwięk inny niż wczoraj, rytmiczny stuk"
...
**Dla kursanta** (handout A):
- KS-001 dnia z wpisami z dni poprzednich (do porównania „wczoraj wszystko OK")
- Pusta KKS-001 (karta konserwacji + stanu maszyny)
- Tabela 7 typów usterek EGIDA z granicą operator/UR/serwis (wydrukowana na A3 obok stanowiska)
- Numer telefonu pana Krzysztofa Wood-Mizer Polska (na liście kontaktów EGIDA)
...
KS-001 z dni poprzednich (przygotowane), pusta KKS-001, tabela 7 usterek na A3, telefon symulacyjny, próbka deski z falami (rzeczywista lub zdjęcie A4), nagranie stuku łożyska (smartfon).
...
- **Kryterium 5 reakcja na incydent (główne, 0-4)**:
  - 4 = zauważył 3 sygnały + diagnoza serwis-level + STOP na końcu rzazu + eskalacja kompletna (KKS + Marek + Wood-Mizer) w 10 min
  - 3 = 2-3 sygnały + diagnoza poprawna + STOP + eskalacja częściowa (np. brak rozmowy z Wood-Mizer bezpośrednio, ale przez Marka)
  - 2 = 1-2 sygnały + diagnoza niejasna lub błędna (operator-level zamiast serwis) + STOP wykonany ale eskalacja niejasna
...
- Pomija sygnał 1 (drobne fale „pewnie tylko jedna deska")
- Diagnoza za szybka „stępnienie taśmy" → wymiana taśmy operator-level → propagacja problemu
- Próba samodzielnej naprawy łożyska (przekroczenie granicy zewnętrznej, zerwanie gwarancji)
- STOP w trakcie rzazu (taśma uwięziona w kłodzie, ryzyko zerwania)
- Eskalacja telefon do Anny Kwiatkowskiej zamiast Marka (przeskok niepotrzebny, Marek dostępny)
- Brak wpisu w KKS-001 (audytor pyta po fakcie, brak dowodu)
...
## Scenariusz 5: „Eskalacja granicy zewnętrznej do Wood-Mizer + dokumentacja kompletna" (kryterium REAKCJA NA INCYDENT)
...
**Dla kursanta** (handout A):
- Wypełniona KKS-001 ze scen. 4 (lub przygotowana przez trenera)
- Numer telefonu Wood-Mizer Polska + imię „Pan Krzysztof Wieliczko, serwis terenowy region Mazury"
- Dane maszyny LT70: numer fabryczny, rok produkcji, status gwarancji (1 rok do końca), historia serwisowa (2 wcześniejsze interwencje)
...
KKS-001 wypełniona, dane LT70 (karta maszyny przygotowana), telefon symulacyjny, dziennik historii serwisowej.
...
2. **Opis symptomów objawowy** (3 zmysły konkretnie, nie diagnoza)
3. **Status plomby antymanipulacyjnej** (kluczowe dla gwarancji)
4. **Historia ostatniej wymiany łożyska** (data, przebieg motogodzin)
5. **Oczekiwania czasowe i lokalizacyjne** (kiedy ekipa, gdzie wjazd)

### Rubryka oceny

- **Kryterium 5 reakcja na incydent (główne, 0-4)**:
  - 4 = wszystkie 5 wymiarów konkretnie + format 4W zachowany + plomba potwierdzona + dialog z panem Krzysztofem profesjonalny
  - 3 = 4 z 5 + drobne luki konkretu
  - 2 = 3 z 5 + ogólniki w 1-2 wymiarach
  - 1 = 1-2 wymiary z konkretem, reszta „nie wiem", pan Krzysztof musi wyciągać klatkami
  - 0 = ogólnikowa rozmowa „mam problem z pilarką, przyjedźcie", pan Krzysztof odmawia autoryzacji bez szczegółów
- **Kryterium 4 dokumentacja (wsparcie)**: po rozmowie wpis do KKS-001 z konkluzją „17.06.2026 11:15 telefon do Wood-Mizer Polska, pan Krzysztof Wieliczko, autoryzacja wyjazdu 15:00, plomba potwierdzona nienaruszona, gwarancja pokrywa"
- **Kryterium 6 komunikacja (wsparcie)**: ton profesjonalny, format 4W, brak emocji nawet jeśli pan Krzysztof zachęca do szczegółów dosadnie

### Common mistakes M3

- Ogólnikowy opis „dziwny dźwięk, wibracja"
- Diagnoza zamiast objawu („uszkodzone łożysko" – pan Krzysztof pyta „a skąd pan wie, że łożysko, a nie łańcuch napędowy?")
- Niewiedza o numerze fabrycznym (nie ma karty maszyny pod ręką)
- Niewiedza o plombie (nie sprawdził fizycznie przed telefonem)
- Brak wpisu post-rozmowy do KKS-001 (audytor pyta „kto autoryzował, kiedy?")
- Emocje w rozmowie (irytacja na dosadność pana Krzysztofa)
...
## Scenariusz 6: „Reklamacja klienta Dom-Bud telefoniczna z KC" (kryterium KOMUNIKACJA)
...
- KC art. 556¹ § 4 + 560 § 4: wada nieistotna nie uprawnia do odstąpienia
- Wyrok SN I NSNc 152/20 z 17.02.2021: potwierdza
...
KEP-001 ZLE-015 (pułapka pole tolerancji puste = ±2 mm), dyspozycja DP-015, maile, druki KC, Wyrok SN, 3 szablony emaili, telefon symulacyjny, pusty EGIDA-RPW-001 (raport reklamacji).
...
- **Kryterium 6 komunikacja (główne, 0-4)**:
  - 4 = wszystkie 5 wymiarów + szablon emaila wybrany poprawnie (wariant 1) + email wysłany do 16:00 z CC do Marka i Anny + EGIDA-RPW-001 wypełniony
  - 3 = 4 z 5 wymiarów + email wysłany ale szablon częściowo dostosowany
  - 2 = 3 z 5 + email opóźniony lub bez CC
  - 1 = 1-2 wymiary, ulega presji ustnej, zgadza się na zwrot bez dokumentacji
  - 0 = zgadza się ustnie na zwrot 3200 zł bez sprawdzenia faktów + bez konsultacji z Markiem
- **Kryterium 4 dokumentacja (wsparcie)**: EGIDA-RPW-001 wypełniona z pełnym timeline + cytatami KC + załącznikami (skan KEP-001, dyspozycji, emaila do klienta)

### Common mistakes M3

- Wpada w emocje fazy 1, podnosi głos
- Zgadza się na zwrot ustnie pod presją „klient się skarży" (akceptacja bez papieru = utrata 3200 zł firmy)
- Cytuje KC pamięciowo z błędem (np. „art. 556 § 4" zamiast „556¹ § 4")
- Pomija PN-EN 336 (klucz: tolerancja standardowa ±2 mm)
- Wybiera szablon wariantu 3 (odmowa z eskalacją) zamiast wariantu 1 (wada nieistotna z propozycją obniżenia) – nadmierna defensywa
- Nie wysyła emaila tego samego dnia (klient czeka, traci wiarygodność)
- Brak CC do Marka (brak audytu wewnętrznego)
...
## Scenariusz 7 INTEGRACYJNY: „Cała zmiana solo z incydentem" (wszystkie 6 kryteriów)
...
Wszystko z poprzednich scenariuszy + plakat 8 zasad + symulator amperomierza (czerwona dioda LED na atrapie panelu).
...
### Rubryka oceny (PEŁNA, 6 kryteriów × 0-4)
...
## Scenariusz 8 INTEGRACYJNY: „Audyt FSC w trakcie zmiany nadzorczej" (kryteria 4+5+6 + 2)
...
- Pełny chain of custody zlecenia ZLE-024 (8 elementów, opisany w scen. 3 ćwiczeń A2)
- Regulamin EGIDA § 8 ust. 3
- Telefon do FSC Connect (rejestr kwartalny, ostatni wpis czerwiec 2026)

**Dla trenera-audytora** (handout B):
- Skrypt 3-częściowy:
  - **Część A (15 min)**: prosi o chain of custody ZLE-024, sprawdza spójność łańcucha 8 elementów, dostępność 15 min
...
Pełny komplet dokumentacji ZLE-024, KAO-001 Adriana z 5 tygodni, telefon (FSC Connect), rejestr odbioru pakietu BUK-FSC, fakturę przygotowaną (do wystawienia w poniedziałek), plakat 8 zasad M3.
...
- Reaguje emocjonalnie na pytanie o Adriana („Adrian kłamie, nie byłem za mocny")
- Tłumaczy się ogólnikami zamiast cytatu regulaminu § 8
- Pokazuje chain of custody z lukami (np. brak rejestru kwartalnego FSC Connect)
- Próbuje „wytłumaczyć Adriana" publicznie zamiast zaproponować rozmowę po audycie
- Pomija własne kompetencje (mówi audytorowi „lepiej zapytajcie Marka") – traci pozycję M3
...
## Sumaryczna rubryka trenera (po 8 scenariuszach)
...
**Feedback dla kursanta**. Po każdym scenariuszu **15 min feedback** z trenerem. Po wszystkich 8 scenariuszach **rozmowa 30 min**: (a) wyniki per kryterium, (b) wyniki per zasada M3 (Z1-Z8), (c) rekomendacja (gotów na egzamin solo +14 dni / potrzebuje powtórki scenariusza X), (d) konkretne ćwiczenia z artefaktów Fazy 4 M3 (quiz uzupełniający lub ćwiczenia teoretyczne dla zasady z luką).

**Integracja z egzaminem praktycznym solo**. Wyniki scenariuszy 1-8 są **prognostyczne dla 6 kryteriów rubryki egzaminu**:
- Kursant z 4/4 na scen. 4-5 = prawdopodobnie 3-4/4 reakcja na incydent w realnej zmianie solo
- Kursant z 2/4 na scen. 6 = ryzyko 1-2/4 komunikacja przy reklamacji rzeczywistej, rekomendacja powtórki
- Kursant z 0/4 na scen. 7 BHP = wysokie ryzyko niezaliczenia, **odłożenie egzaminu solo o 4 tygodnie + 16 h dodatkowego BHP M1 powtórka**

**Kalibracja trenera**. Po pierwszych 2 kursantach trener porównuje swoje oceny z **Anną Kwiatkowską** (przewodnicząca komisji egzaminu solo) na 1 wspólnym scenariuszu (najlepiej sc. 7 lub 8). Cel: spójność kalibracji 6-kryteryjnej między trenerem próbnym a komisją egzaminacyjną.

**Sekwencja czasowa**:
- **Tydzień 4 M3 (przed testem l8)**: scenariusze 1-4 (po jednym dziennie poniedziałek-czwartek)
- **Tydzień 1 między testem a egzaminem solo**: scenariusze 5-6 (środa + piątek)
- **Tydzień 2 między testem a egzaminem solo**: scenariusze 7-8 (poniedziałek + środa, integracyjne pełne)
- **Piątek tygodnia 2** (na 2-3 dni przed egzaminem solo): rozmowa 30 min sumaryczna z trenerem

**Materiały do druku jako pakiet**. Trener przygotowuje **8 teczek scenariuszowych** (po jednej na scenariusz), każda zawiera handouty A + B + C (jeśli) + listę rekwizytów + rubrykę + skrypt rola. Teczki w archiwum EGIDA, używane cyklicznie w kolejnych kohortach M3 (aktualizacja roczna).
